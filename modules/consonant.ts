...
const consonants: TIPA[] = [
  {
    ...
    examples: [
      { value: "pen", transcription: "/pen/", audio: "", meaning: "cây bút" },
      ...
      { value: "speak", transcription: "/spiːk/", audio: "", meaning: "nói" },
      {
        value: "happy",
        transcription: "/ˈhæpi/",
        audio: "",
  ...
  },
  {
    ...
    examples: [
      ...
      { value: "table", transcription: "/ˈteɪbl/", audio: "", meaning: "bàn" },
  ...
  },
  {
    ...
    examples: [
      { value: "tea", transcription: "/tiː/", audio: "", meaning: "trà" },
      {
        value: "stop",
        transcription: "/stɒp/",
        audio: "",
  ...
  },
  {
    ...
    examples: [
      ...
      { value: "bad", transcription: "/bæd/", audio: "", meaning: "tồi tệ" },
      { value: "read", transcription: "/riːd/", audio: "", meaning: "đọc" },
      {
        value: "ladder",
  ...
  },
  {
    ...
    examples: [
      { value: "key", transcription: "/kiː/", audio: "", meaning: "chìa khóa" },
    ...
    identify: {
      ...
      ck: [
        { value: "back", transcription: "/bæk/", audio: "", meaning: "lưng" },
        {
          value: "black",
          transcription: "/blæk/",
          audio: "",
  ...
  },
  {
    ...
    examples: [
      ...
      { value: "again", transcription: "/əˈɡen/", audio: "", meaning: "lại" },
    ],
    exceptions: [
      {
        value: "ghost",
    ...
    identify: {
      ...
      gh: [
        { value: "ghost", transcription: "/ɡəʊst/", audio: "", meaning: "ma" },
      ],
      gu: [
        {
          value: "guide",
  ...
  // FRICATIVES
  {
    ...
    examples: [
      { value: "fan", transcription: "/fæn/", audio: "", meaning: "quạt" },
    ...
    identify: {
      ...
      gh: [
        { value: "laugh", transcription: "/lɑːf/", audio: "", meaning: "cười" },
        { value: "enough", transcription: "/ɪˈnʌf/", audio: "", meaning: "đủ" },
      ],
    },
  },
  {
    ...
    examples: [
      ...
      { value: "very", transcription: "/ˈveri/", audio: "", meaning: "rất" },
      { value: "love", transcription: "/lʌv/", audio: "", meaning: "tình yêu" },
      { value: "five", transcription: "/faɪv/", audio: "", meaning: "năm" },
      {
        value: "never",
    ...
    identify: {
      ...
      f: [{ value: "of", transcription: "/ɒv/", audio: "", meaning: "của" }],
    },
  },
  {
    symbol: "/θ/",
    type: "fricative",
    keyword: "thin",
    audio: "https://example.com/audio/θ.mp3",
    description:
    ...
    examples: [
      { value: "thin", transcription: "/θɪn/", audio: "", meaning: "mỏng" },
      {
        value: "think",
        transcription: "/θɪŋk/",
        audio: "",
      ...
      { value: "bath", transcription: "/bɑːθ/", audio: "", meaning: "bồn tắm" },
      {
        value: "healthy",
  ...
  },
  {
    ...
    type: "fricative",
    keyword: "this",
    audio: "https://example.com/audio/ð.mp3",
    description:
    ...
    examples: [
      { value: "this", transcription: "/ðɪs/", audio: "", meaning: "này" },
      { value: "that", transcription: "/ðæt/", audio: "", meaning: "đó" },
      {
        value: "the",
        transcription: "/ðə/",
        audio: "",
  ...
  },
  {
    ...
    examples: [
      ...
      { value: "miss", transcription: "/mɪs/", audio: "", meaning: "nhớ" },
      {
        value: "city",
        transcription: "/ˈsɪti/",
        audio: "",
    ...
    identify: {
      ...
      c: [
        ...
        { value: "rice", transcription: "/raɪs/", audio: "", meaning: "gạo" },
      ],
      sc: [
        {
          value: "science",
  ...
  },
  {
    ...
    examples: [
      { value: "zoo", transcription: "/zuː/", audio: "", meaning: "vườn thú" },
      {
        value: "zero",
  ...
  },
  {
    ...
    type: "fricative",
    keyword: "she",
    audio: "https://example.com/audio/ʃ.mp3",
    description:
    ...
    examples: [
      { value: "she", transcription: "/ʃiː/", audio: "", meaning: "cô ấy" },
      { value: "ship", transcription: "/ʃɪp/", audio: "", meaning: "tàu thủy" },
  ...
  },
  {
    ...
    type: "fricative",
    keyword: "measure",
    audio: "https://example.com/audio/ʒ.mp3",
    description:
    ...
    examples: [
      ...
      { value: "beige", transcription: "/beɪʒ/", audio: "", meaning: "màu be" },
    ],
    exceptions: [],
    identify: {
      s: [
  ...
  },
  {
    ...
    identify: {
      ...
      wh: [
        { value: "who", transcription: "/huː/", audio: "", meaning: "ai" },
        {
          value: "whole",
          transcription: "/həʊl/",
          audio: "",
  ...
  // AFFRICATES
  {
    ...
    type: "affricate",
    keyword: "chair",
    audio: "https://example.com/audio/tʃ.mp3",
    description:
  ...
  },
  {
    ...
    type: "affricate",
    keyword: "jam",
    audio: "https://example.com/audio/dʒ.mp3",
    description:
    ...
    examples: [
      { value: "jam", transcription: "/dʒæm/", audio: "", meaning: "mứt" },
      {
        value: "job",
        transcription: "/dʒɒb/",
        audio: "",
      ...
      { value: "age", transcription: "/eɪdʒ/", audio: "", meaning: "tuổi" },
      {
        value: "bridge",
        transcription: "/brɪdʒ/",
        audio: "",
    ...
    identify: {
      ...
      dg: [
        ...
        { value: "edge", transcription: "/edʒ/", audio: "", meaning: "cạnh" },
      ],
      di: [
        {
          value: "soldier",
  ...
  // NASALS
  {
    ...
    examples: [
      { value: "man", transcription: "/mæn/", audio: "", meaning: "đàn ông" },
      {
        value: "mother",
        transcription: "/ˈmʌðə(r)/",
        audio: "",
      ...
      { value: "come", transcription: "/kʌm/", audio: "", meaning: "đến" },
      {
        value: "summer",
    ...
    identify: {
      ...
      mb: [
        ...
        { value: "comb", transcription: "/kəʊm/", audio: "", meaning: "lược" },
      ],
    },
  },
  {
    ...
    examples: [
      { value: "no", transcription: "/nəʊ/", audio: "", meaning: "không" },
      { value: "name", transcription: "/neɪm/", audio: "", meaning: "tên" },
      { value: "sun", transcription: "/sʌn/", audio: "", meaning: "mặt trời" },
  ...
  },
  {
    ...
    type: "nasal",
    keyword: "sing",
    audio: "https://example.com/audio/ŋ.mp3",
    description:
    ...
    examples: [
      { value: "sing", transcription: "/sɪŋ/", audio: "", meaning: "hát" },
      {
        value: "ring",
        transcription: "/rɪŋ/",
        audio: "",
      ...
      { value: "thing", transcription: "/θɪŋ/", audio: "", meaning: "vật" },
      {
        value: "English",
  ...
  // APPROXIMANTS
  {
    ...
    examples: [
      { value: "leg", transcription: "/leɡ/", audio: "", meaning: "chân" },
      { value: "like", transcription: "/laɪk/", audio: "", meaning: "thích" },
      {
        value: "feel",
        transcription: "/fiːl/",
  ...
  },
  {
    ...
    examples: [
      ...
      { value: "right", transcription: "/raɪt/", audio: "", meaning: "đúng" },
      ...
      { value: "write", transcription: "/raɪt/", audio: "", meaning: "viết" },
    ],
    exceptions: [],
    identify: {
      r: [
      ...
      wr: [
        { value: "write", transcription: "/raɪt/", audio: "", meaning: "viết" },
        { value: "wrong", transcription: "/rɒŋ/", audio: "", meaning: "sai" },
      ],
    },
  },
  {
    ...
    examples: [
      { value: "wet", transcription: "/wet/", audio: "", meaning: "ướt" },
      {
        value: "water",
        transcription: "/ˈwɔːtə(r)/",
        audio: "",
      ...
      { value: "swim", transcription: "/swɪm/", audio: "", meaning: "bơi" },
      {
        value: "always",
      ...
      { value: "one", transcription: "/wʌn/", audio: "", meaning: "một" },
    ],
    exceptions: [],
    identify: {
      w: [
      ...
      wh: [
        { value: "what", transcription: "/wɒt/", audio: "", meaning: "cái gì" },
        {
          value: "when",
          transcription: "/wen/",
          audio: "",
  ...
  },
  {
    ...
    examples: [
      { value: "yes", transcription: "/jes/", audio: "", meaning: "có" },
      {
        value: "yellow",
        transcription: "/ˈjeləʊ/",
        audio: "",
      ...
      { value: "you", transcription: "/juː/", audio: "", meaning: "bạn" },
      { value: "year", transcription: "/jɪə(r)/", audio: "", meaning: "năm" },
      { value: "use", transcription: "/juːz/", audio: "", meaning: "sử dụng" },
    ],
    exceptions: [],
    identify: {
      y: [
